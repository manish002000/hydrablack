#!/usr/bin/python
"""
Program ini hanyalah sebuah program kecil untuk mempersingkat sesi brute force pada hydra :).
Tapi agar lebih memuaskan hasil brute force tersebut. Lebih baik anda berinteraksi secara langsung dengan hydra
Tanpa harus menggunakan konsol black hydra ini lebih dulu :').
Apabila anda mendapati kesalahan dalam menjalankan program kami. Bisa chat lewat facebook :).
Facebook Saya : https://www.facebook.com/100004136748473
Hydra sangatlah dibutuhkan untuk proses kerjanya program ini :)
"""
import sys, os, time
...
print "c=={:::::::::::::::> Hydra Console For Android"
